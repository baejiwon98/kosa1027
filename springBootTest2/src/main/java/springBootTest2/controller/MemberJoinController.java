...
import springBootTest2.service.membership.MembershipInfoService;
import springBootTest2.service.membership.MembershipUpdateService;
...
public class MemberJoinController {
	...
	@Autowired
	MembershipInfoService memberInfoService;
	@Autowired
	MembershipUpdateService memberUpdateService;
	@Autowired
	...
	public String memberDropOk(@RequestParam(value="memPw") String memPw, Model model,HttpSession session) {
		...
		if(authInfo.getUserPw().equals(memPw)) {
			...
			return "thymeleaf/membership/memberDropPass";
		}
	}
